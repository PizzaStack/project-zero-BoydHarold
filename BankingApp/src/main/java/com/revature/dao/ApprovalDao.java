...
public class ApprovalDao {
	...
	public List<Approval> getAllCheckingAccounts() {
		...
		try {
			...
			preGetAllCheckingAccounts = EstablishConnection.connection.prepareStatement(
					"SELECT ca.CustomerId, ca.Status, ca.ApprovalStatus, cus.FirstName, cus.LastName FROM CheckingAccount ca JOIN Customer cus ON ca.CustomerId = cus.CustomerId;");
	...
	public List<Approval> getAllSavingsAccounts() {
		...
		try {
			...
			preGetAllSavingsAccounts = EstablishConnection.connection.prepareStatement(
					"SELECT sa.CustomerId, sa.Status, sa.ApprovalStatus, cus.FirstName, cus.LastName FROM SavingsAccount sa JOIN Customer cus ON sa.CustomerId = cus.CustomerId;");
	...
	public List<Approval> getAllJointAccounts() {
		...
		try {
			...
			preGetAllJointAccounts = EstablishConnection.connection.prepareStatement(
					"SELECT ja.CustomerId1, ja.CustomerId2, ja.Status, ja.ApprovalStatus, cus.FirstName, cus.LastName FROM Customer cus JOIN JointAccount ja ON cus.CustomerId = ja.CustomerId1 OR cus.CustomerId = ja.CustomerId2;");
			...
			while (rs.next()) {
				...
				approval = new Approval(customerId1, customerId2, status, approvalStatus, firstName1, lastName1,
	...
	public List<Employee> getAllEmployees() {
		...
		try {
			PreparedStatement preGetAllEmployees = EstablishConnection.connection
	...
	public List<Administrator> getAllAdministrators() {
		...
		try {
			PreparedStatement preGetAllAdministrators = EstablishConnection.connection
					.prepareStatement("SELECT * FROM Administrator;");
	...
	public void updateCheckingAccount(Approval approval) {
		try {
			...
			preUpdateCheckingAccount = EstablishConnection.connection.prepareStatement(
					"UPDATE CheckingAccount SET Status = ?, ApprovalStatus = ? WHERE CustomerId = ?;");
	...
	public void updateSavingsAccount(Approval approval) {
		try {
			...
			preUpdateSavingsAccount = EstablishConnection.connection
					.prepareStatement("UPDATE SavingsAccount SET Status = ?, ApprovalStatus = ? WHERE CustomerId = ?;");
	...
	public void updateJointAccount(Approval approval) {
		try {
			...
			preUpdateJointAccount = EstablishConnection.connection.prepareStatement(
					"UPDATE JointAccount SET Status = ?, ApprovalStatus = ? WHERE CustomerId1 = ? OR CustomerId2 = ?;");
	...
	public void deleteJointAccount(Approval approval) {
		try {
			...
			preDeleteJointAccount = EstablishConnection.connection
					.prepareStatement("DELETE FROM JointAccount WHERE CustomerId1 = ? OR CustomerId2 = ?;");
	...
	public void updateEmployee(Employee employee) {
		try {
			...
			preUpdateEmployee = EstablishConnection.connection
					.prepareStatement("UPDATE Employee SET Status = ?, ApprovalStatus = ? WHERE EmployeeId = ?;");
			...
			preUpdateEmployee = EstablishConnection.connection
					.prepareStatement("UPDATE EmployeeUsers SET Status = ? WHERE EmployeeId = ?;");
			preUpdateEmployee.setInt(1, employee.getEmployeeIsActive());
	...
	public void deleteEmployee(Employee employee) {
		try {
			...
			preDeleteEmployee = EstablishConnection.connection
					.prepareStatement("DELETE FROM EmployeeUsers WHERE EmployeeId = ?;");
	...
	public void updateAdministrator(Administrator administrator) {
		try {
			...
			preUpdateAdministrator = EstablishConnection.connection.prepareStatement(
					"UPDATE Administrator SET Status = ?, ApprovalStatus = ? WHERE AdministratorId = ?;");
			...
			preUpdateAdministrator = EstablishConnection.connection
					.prepareStatement("UPDATE AdministratorUsers SET Status = ? WHERE AdministratorId = ?;");
			preUpdateAdministrator.setInt(1, administrator.getAdministratorIsActive());
	...
	public void deleteAdministrator(Administrator administrator) {
		try {
			...
			preDeleteAdministrator = EstablishConnection.connection
					.prepareStatement("DELETE FROM AdministratorUsers WHERE AdministratorId = ?;");
			preDeleteAdministrator.setInt(1, administrator.getAdministratorId());
			preDeleteAdministrator.executeUpdate();
			preDeleteAdministrator = EstablishConnection.connection
					.prepareStatement("DELETE FROM Administrator WHERE AdministratorId = ?;");
			preDeleteAdministrator.setInt(1, administrator.getAdministratorId());
			preDeleteAdministrator.executeUpdate();
