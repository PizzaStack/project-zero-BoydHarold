...
public class Approval {
	...
	public Approval(int customerId1, int customerId2, int status, String approvalStatus, String firstName,
			String lastName, String firstName2, String lastName2) {
		...
		if (pendingCount > 0) {
			...
			for (Approval checkingAccount : checkingAccounts) {
				if (checkingAccount.getApprovalStatus().equals("p")) {
					...
					System.out.println(
							"Full Name: " + checkingAccount.getFirstName() + " " + checkingAccount.getLastName());
		...
		if (pendingCount > 0) {
			...
			for (Approval savingsAccount : savingsAccounts) {
				if (savingsAccount.getApprovalStatus().equals("p")) {
					...
					System.out.println(
							"Full Name: " + savingsAccount.getFirstName() + " " + savingsAccount.getLastName());
					System.out.println("Approval Status: Pending");
				}
			}
	...
	public void listPendingJoint() {
		...
		if (pendingCount > 0) {
			...
			for (Approval jointAccount : jointAccounts) {
				if (jointAccount.getApprovalStatus().equals("p")) {
					System.out.println("\nCustomer Ids: '" + jointAccount.getCustomerId() + "' and '"
							+ jointAccount.getCustomerId2() + "'");
					System.out.println("Full Names: '" + jointAccount.getFirstName() + " " + jointAccount.getLastName()
							+ "' and '" + jointAccount.getFirstName2() + " " + jointAccount.getLastName2() + "'");
					System.out.println("Approval Status: Pending");
				}
			}
		} else {
		...
		if (pendingCount > 0) {
			...
			for (Employee employee : employees) {
				if (employee.getApprovalStatus().equals("p")) {
					...
					System.out.println(
							"Employee name: " + employee.getEmployeeFirstName() + " " + employee.getEmployeeLastName());
					System.out.println("Approval Status: Pending");
				}
			}
		} else {
		...
		if (pendingCount > 0) {
			...
			for (Administrator administrator : administrators) {
				if (administrator.getApprovalStatus().equals("p")) {
					...
					System.out.println("Administrator name: " + administrator.getAdministratorFirstName() + " "
		...
		if (pendingCount > 0) {
			for (Employee employee : employees) {
				if (employee.getEmployeeId() == id) {
					employeeChosen = new Employee(employee.getEmployeeFirstName(), employee.getEmployeeLastName(),
							employee.getEmployeeAddress(), employee.getEmployeeBirthDate(),
							employee.getEmployeeEmailAddress(), employee.getEmployeePhoneNumber(),
							employee.getEmployeeIsActive(), employee.getApprovalStatus());
		...
		if (pendingCount > 0) {
			for (Administrator administrator : administrators) {
				if (administrator.getAdministratorId() == id) {
					administratorChosen = new Administrator(administrator.getAdministratorFirstName(),
							administrator.getAdministratorLastName(), administrator.getAdministratorAddress(),
							administrator.getAdministratorBirthDate(), administrator.getAdministratorEmailAddress(),
							administrator.getAdministratorPhoneNumber(), administrator.getAdministratorIsActive(),
