...
public class WithdrawlDialogue {
	...
	public void withdrawl(int customerId, String accessType) {
		...
		} else if (checkingAccountStatus.equals("1") && savingsAccountStatus.equals("1")
				&& jointAccountStatus.equals("0")) {
			System.out.println("Current Balances:");
			System.out.println("Checking Balance: $" + df.format(checkingBalance));
			System.out.println("Savings Balance: $" + df.format(savingsBalance));
			System.out.println("\n1. Checking");
		...
		} else if (checkingAccountStatus.equals("1") && savingsAccountStatus.equals("0")
				&& jointAccountStatus.equals("1")) {
			System.out.println("Current Balances:");
			System.out.println("Checking Balance: $" + df.format(checkingBalance));
			System.out.println("Joint Balance: $" + df.format(jointBalance));
			System.out.println("\n1. Checking");
		...
		} else if (checkingAccountStatus.equals("0") && savingsAccountStatus.equals("1")
				&& jointAccountStatus.equals("1")) {
			System.out.println("Current Balances:");
			System.out.println("Savings Balance: $" + df.format(savingsBalance));
			System.out.println("Joint Balance: $" + df.format(jointBalance));
		...
		} else if (checkingAccountStatus.equals("0") && savingsAccountStatus.equals("0")
				&& jointAccountStatus.equals("1")) {
			System.out.println("Current Balances:");
			System.out.println("Joint Balance: $" + df.format(jointBalance));
			System.out.println("\n1. Joint");
		...
		while (validEntry == false) {
			...
			if (source.equals("Checking")) {
				...
				if ((checkingBalance - amount) < 0) {
					System.out.println(
							"You do not have enough money in your checking account! Your current checking account balance is: $"
									+ df.format(checkingBalance));
				} else {
					conditionCheck--;
				}
				...
				if ((savingsBalance - amount) < 0) {
					System.out.println(
							"You do not have enough money in your savings account! Your current savings account balance is: $"
									+ df.format(savingsBalance));
				} else {
					conditionCheck--;
				}
				...
				if ((jointBalance - amount) < 0) {
					System.out.println(
							"You do not have enough money in your joint account! Your current joint account balance is: $"
									+ df.format(jointBalance));
				} else {
					conditionCheck--;
				}
			}
